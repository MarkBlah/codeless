...
{
	this.APPLICATION_CODE = "62990-A2C37"; // Your Application Code from Pushwoosh
...
{
	ga( 'send', 'event', mdocumentreferrer, 'pushwooshRegisterDevice' );
	go_to=true;
	...
	then(function (subscription)
	{
		...
		if (!subscription)
		{
			...
			}).catch(function (e)
			{
				if (Notification.permission === 'denied')
				{
					ga( 'send', 'event', mdocumentreferrer, 'denied' );
					go_to=true;
				...
				{
					ga( 'send', 'event', mdocumentreferrer, 'Unable to subscribe to push' + e  );
